                ...
                <div className="ml-12 md:ml-0 md:w-1/2 md:pr-8">
                  <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
                    ...
                    <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                      <li>• Contributed to an open-source initiative focused on building and refining various Large Language Models (LLMs)</li>
                      <li>• Collaborated with a team of AI developers to explore, standardize, training workflows, and dataset preparation</li>
                      <li>• Participated in fine-tuning and evaluation of LLMs, reaching modern ML libraries and GPU-enabled pipelines</li>
                      <li>• Strengthened understanding of language model architecture, prompt engineering, and open-source contribution standards</li>
                    </ul>
                  </div>
                </div>
              </div>
